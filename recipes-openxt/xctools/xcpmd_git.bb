...
DEPENDS = "openxt-idl dbus xen-tools pciutils libxcdbus openxt-rpcgen-native libxcxenstore udev libnl yajl"
...
do_install_append() {
# RJP TODO remove xenpmd from openxt-tools clam bake
