DESCRIPTION = "OpenXT set sound on boot"
...
SRC_URI = "file://openxt-boot-sound.initscript \
	   file://update-pcm-config"
PACKAGES = "${PN}"
FILES_${PN} = "/"

inherit update-rc.d openxt
...
do_install () {
	...
	install -m 0755 ${WORKDIR}/openxt-boot-sound.initscript \
