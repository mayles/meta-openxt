...
# image recipe.
#
# For example, for the openxt-dom0-image recipe, creates a package
# openxt-dom0-image-sources which depends on busybox-src, openssh-src and so
# on.
#
...
# the openxt-dom0-image recipe must be built using:
#
#     ./bb openxt-dom0-image
#
# rather than:
#
#     ./bb -b openxt/recipes/images/openxt-dom0-image.bb
